...
**6. Check it.** Open `https://your-app.up.railway.app/` for the status page, then `/admin` to log in with your `ADMIN_TOKEN` and run agents from the browser.
...
Auth is the `x-admin-token` header matching `ADMIN_TOKEN`.
